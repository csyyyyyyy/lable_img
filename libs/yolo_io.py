...
class YOLOWriter:
    ...
    def BndBox2YoloLine(self, box, classList=[]):
        ...
        return classname, xcen, ycen, w, h
    '''
    def save(self, classList,targetFile=None):
        ...
        for box in self.boxlist:
            # classname, xcen, ycen, w, h =box['name'],box['xmin'],box['max'],box['ymin'],box['ymax']
            # print (classname, xcen, ycen, w, h)
            out_file.write("%s %.6f %.6f %.6f %.6f \n" % (box['name'],box['xmin'],box['xmax'],box['ymin'],box['ymax']))
